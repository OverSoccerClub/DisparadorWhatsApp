-- ============================================================================
-- SCRIPT SQL - SISTEMA DE DISPAROS WAHA
-- Execute este script para criar apenas as tabelas necessárias para disparos WAHA
-- ============================================================================
...
-- ============================================================================
-- 3. TABELAS DO SISTEMA DE DISPAROS WAHA
-- ============================================================================
...
-- Mensagem de sucesso
SELECT 
    '🎉 SISTEMA DE DISPAROS WAHA CRIADO COM SUCESSO!' as status,
    'Todas as tabelas, índices, triggers e policies foram configurados' as detalhes;
