...
exports.EvolutionConfigService = void 0;
...
class EvolutionConfigService {
    ...
    static async getUserInstances(userId) {
        try {
    ...
    static async updateInstanceStatus(userId, instanceName, updates) {
        try {
    ...
    // Excluir instância
    static async deleteInstance(userId, instanceName) {
        try {
            const { data, error } = await supabase
                .from('evolution_instances')
                .delete()
    ...
    static async getInstance(userId, instanceName) {
        try {
            const { data, error } = await supabase
                .from('evolution_instances')
                .select('*')
...
exports.EvolutionConfigService = EvolutionConfigService;
