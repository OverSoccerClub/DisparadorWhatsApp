...
class EmailService {
     ...
     */
    static async sendViaResend(options) {
     ...
     */
    static async sendViaSMTP(options) {
     ...
     */
    static generateActivationEmail(name, activationCode) {
...
EmailService.RESEND_API_KEY = process.env.RESEND_API_KEY;
EmailService.SENDGRID_API_KEY = process.env.SENDGRID_API_KEY;
EmailService.SMTP_HOST = process.env.SMTP_HOST;
EmailService.SMTP_PORT = process.env.SMTP_PORT ? parseInt(process.env.SMTP_PORT) : 587;
EmailService.SMTP_USER = process.env.SMTP_USER;
EmailService.SMTP_PASS = process.env.SMTP_PASS;
EmailService.SMTP_FROM = process.env.SMTP_FROM || process.env.SMTP_USER;
EmailService.EMAIL_PROVIDER = process.env.EMAIL_PROVIDER || 'resend'; // resend, sendgrid, smtp
