...
export default function LandingPage() {
  ...
  if (!mounted || checkingAuth) {
    return (
      <>
        <Head>
          <title>Fluxus Message - Automação Inteligente</title>
        </Head>
        <div className="min-h-screen bg-gradient-to-br from-secondary-50 via-white to-primary-50 dark:from-secondary-900 dark:via-secondary-800 dark:to-secondary-900 flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary-600 mx-auto mb-4"></div>
            <p className="text-secondary-600 dark:text-secondary-400">Carregando...</p>
          </div>
        </div>
      </>
    )
  ...
  return (
    <>
      <Head>
        <title>Fluxus Message - Automação Inteligente</title>
        <meta name="description" content="Plataforma profissional para automação e disparo de mensagens WhatsApp e Telegram" />
      </Head>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-secondary-900 dark:text-secondary-100 mb-6">
                  Por que escolher o Fluxus Message?
                </h2>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center space-x-3 mb-4 md:mb-0">
                ...
                />
                <span className="text-secondary-400">Fluxus Message {formatVersion()}</span>
              </div>
              <div className="text-secondary-400 text-sm">
                © {new Date().getFullYear()} Fluxus Message. Todos os direitos reservados.
              </div>
            </div>
          </div>
        </footer>
